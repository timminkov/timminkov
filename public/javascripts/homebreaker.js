...
},{"./states/boot":2,"./states/gameover":3,"./states/menu":4,"./states/play":5,"./states/player":6,"./states/preload":7,"./states/win":8}],2:[function(require,module,exports){
...
module.exports = Menu;
  ...
  Play.prototype = {
    create: function() {
      ...
      var playa = new Player(this.game);
      console.log(playa);
      var style = { font: "90px Arial", fill: "#ff0044", align: "center" };
      this.text = this.add.text(150, 200, playa.text, style);
